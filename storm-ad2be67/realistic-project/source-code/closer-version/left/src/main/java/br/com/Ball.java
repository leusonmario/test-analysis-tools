...
public class Ball {
    ...
    public Ball(long offsetCommitPeriodMs, int maxUncommittedOffsets, String firstPollOffsetStrategy, String kafkaSpoutStreams, String tuplesBuilder, String retryService, String kafkaProps, String keyDeserializer, String valueDeserializer, long pollTimeoutMS) {
